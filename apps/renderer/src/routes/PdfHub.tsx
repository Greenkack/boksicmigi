        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4 mb-6">
            <div>
              ...
              <select className="w-full rounded border border-slate-300 px-3 py-2" title="Anzahl Firmen auswählen">
            ...
            <div>
              ...
              <select className="w-full rounded border border-slate-300 px-3 py-2" title="Preis-Staffelung auswählen">
            ...
            <div>
              ...
              <select className="w-full rounded border border-slate-300 px-3 py-2" title="Rotation auswählen">
