        ...
        <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <div className="flex gap-3 items-center">
            <input
              ...
              title="Produktdatenbank-Datei auswählen (Excel oder CSV)"
              aria-label="Produktdatenbank-Datei auswählen (Excel oder CSV)"
            />
        ...
        {isFormOpen && (
          <div className="mb-6 p-6 bg-gray-50 rounded-lg border">
            <form onSubmit={handleSubmit}>
                  ...
                  <>
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Kapazität in Watt eingeben"
                        title="Kapazität des Moduls in Watt"
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                    </div>
              ...
              {/* Image upload */}
              <div className="mb-4">
                <label htmlFor="product-image" className="block text-sm font-medium text-gray-700 mb-1">Produktbild (PNG, JPG, max. 2MB)</label>
                <input
                  id="product-image"
                  type="file"
                  accept=".png,.jpg,.jpeg"
                  title="Produktbild auswählen (PNG, JPG, max. 2MB)"
                  aria-label="Produktbild auswählen (PNG, JPG, max. 2MB)"
                  onChange={(e) => {
