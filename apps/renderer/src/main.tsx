      ...
      <ProjectProvider>
        ...
        <Routes>
          <Route path="/" element={<AppLayout />}>
            ...
            {/* PDF Routes - Using Real Python Backend Components */}
            <Route path="pdf/standard" element={<StandardPDFGenerator />} />
            <Route path="pdf/multi" element={<MultiPDFGenerator />} />
            
            {/* CRM Routes - Single Dashboard Only */}
            <Route path="crm/dashboard" element={<Dashboard />} />
            
            {/* Planning Routes - Single Info Portal */}
            <Route path="planning/info" element={<Dashboard />} />
            
            {/* Admin Routes - Single Product Management */}
